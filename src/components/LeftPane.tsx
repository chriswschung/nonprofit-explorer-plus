    ...
    <div className="glass-card" style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
      ...
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '0.8rem' }}>
          <div>
            ...
            <h2 style={{ fontSize: '1.25rem', color: '#fff', margin: '0.3rem 0 0.2rem 0', fontWeight: 800 }}>
              {nonprofit.name}
            </h2>
            <div style={{ display: 'flex', gap: '0.8rem', fontSize: '0.78rem', color: 'var(--text-secondary)', flexWrap: 'wrap' }}>
              <span>EIN: <strong style={{ color: '#fff' }}>{nonprofit.ein}</strong></span>
              <span>• Tax Year: <strong style={{ color: '#fff' }}>{nonprofit.taxYear}</strong></span>
              <span style={{ display: 'flex', alignItems: 'center', gap: '0.2rem' }}>
                <MapPin size={12} color="#818cf8" /> {nonprofit.cityState}
              </span>
            </div>
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '0.65rem' }}>
        ...
        <div style={{ background: 'rgba(15, 23, 42, 0.6)', padding: '0.75rem', borderRadius: '8px', border: '1px solid var(--border-subtle)' }}>
          ...
          <span style={{ fontSize: '1.05rem', color: '#f59e0b', fontWeight: 800 }}>{formatCurrency(ceo ? ceo.compensation : 0)}</span>
        ...
        <div style={{ background: 'rgba(15, 23, 42, 0.6)', padding: '0.75rem', borderRadius: '8px', border: '1px solid var(--border-subtle)' }}>
          ...
          <span style={{ fontSize: '1.05rem', color: '#818cf8', fontWeight: 800 }}>{nonprofit.operatingReserveMonths} mo</span>
      ...
      <div style={{ background: 'rgba(15, 23, 42, 0.6)', padding: '0.9rem', borderRadius: '8px', border: '1px solid var(--border-subtle)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.78rem', color: '#fff', fontWeight: 600, marginBottom: '0.4rem' }}>
        ...
        <div style={{ height: '8px', borderRadius: '4px', background: '#1e293b', overflow: 'hidden', display: 'flex', margin: '0.4rem 0 0.6rem 0' }}>
          ...
          <div style={{ width: `${nonprofit.revenueSources.investmentIncome}%`, background: '#f59e0b' }} title="Investment Income" />
          <div style={{ width: `${nonprofit.revenueSources.otherRevenue}%`, background: '#64748b' }} title="Other Revenue" />
        </div>
        ...
        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', fontSize: '0.72rem', color: 'var(--text-secondary)' }}>
          ...
          <span><span style={{ color: '#f59e0b' }}>■</span> Investment: {nonprofit.revenueSources.investmentIncome}%</span>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: '0.8rem', color: '#fff', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
          {nonprofit.peers.map((peer) => (
            ...
            >
              <div>
                <div style={{ fontSize: '0.8rem', color: '#fff', fontWeight: 600 }}>{peer.name}</div>
